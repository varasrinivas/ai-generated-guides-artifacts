...
**How to run:** Agentic loop. Unattended approvals for mechanical categories (imports,
package moves, starter renames); switch to `approval_policy = "untrusted"` and confirm
